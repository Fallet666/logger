...
Logger::Logger::Logger(std::string name, std::ostream &out) : name{std::move(name)}, out{out} {
}

std::string Logger::Logger::formatLog(LogLevel level, const std::string &message) {
...
void Logger::Logger::logMessage(LogLevel level, const std::string &message) {
